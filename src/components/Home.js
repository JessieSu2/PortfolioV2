...
function Achievement(achievement) {
  return (
    <div>
      ...
      <img src={achievement.imgSrc} className="Achievement-Image" alt="cover"></img>
  ...
  return (
    <div className="background">
      ...
      <section className="Introduction fullscreen" >
        <div>
          <p>Hi, i'm</p>
          <h1 className="gradient-text title">Jessie Su</h1>
          <p className="">a</p>
          <h2 className="gradient-text title">Software Engineer</h2>
          <p className="">Who</p>
          <p className="">
            Loves making a positive impact
          </p>
